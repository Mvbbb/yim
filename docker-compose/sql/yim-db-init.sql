...
(
	...
	owner_uid varchar(100) not null comment '群主',
...
(
	...
	from_uid varchar(20) not null comment '发送者',
	to_uid varchar(20) null comment '接收者',
	session_type tinyint not null,
	group_id varchar(20) null comment '群 id',
	msg_type tinyint not null comment '消息类型',
	msg_data varchar(266) not null comment '消息内容',
