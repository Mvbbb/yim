...
<!--        <router-link to="/forgetAccount"></router-link>-->
        ...
        <router-link to="/forgetPwd"> <el-button type="text" size="mini" style="font-size: 8px;left: 240px;position: relative;">忘记密码</el-button></router-link>

      </el-row>
      <el-row>
        <br>
        <el-button round  type="success" style="width: 250px;left: 140px;position: relative;font-size: 18px;margin-bottom: 10px" @click="login">登录</el-button>
      </el-row>

      <el-row>
        <router-link to="/register"><el-button round type="warning" style="width: 250px;left: 140px;position: relative;font-size: 18px;padding-bottom: 10px">
